...
public abstract class CrudeRestServiceImpl<DTO extends NonRemovableDto> implements CrudeRestService<DTO> {
	 ...
	 *            REST service.
	 * @param restProperties <code>RestProperties</code> with data for
	 *            connecting to REST service.
	 */
	public CrudeRestServiceImpl(RestTemplate restTemplate, RestProperties restProperties) {
	 ...
	 * all requests are read from <code>RestProperties</code>. Only the path for
	...
	/**
	 * Gets the <code>RestProperties</code> with data for accessing the REST
	 * service.
	 * 
	 * @return The <code>RestProperties</code> with data for accessing the REST
	 *         service.
	 */
