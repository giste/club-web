...
public abstract class CrudeRestServiceTest<DTO extends NonRemovableDto> {
	...
	// Constants for mocked RestProperties.
	 ...
	 *            REST server.
	 * @param restProperties RestProperties used by the service to know the REST
	 *            server address.
	 * @return The created service to test.
	 */
	protected abstract CrudeRestService<DTO> getRestService(RestTemplate restTemplate, RestProperties restProperties);
	 ...
	 * <li>Builds and mock <code>RestProperties</code> for testing.</li>
	 ...
	 * {@link #getRestService(RestTemplate, RestProperties)}, passing the
	 * created <code>RestTemplate</code> and <code>RestProperties</code> as
	 * parameters.</li>
	...
	public void setUp() {
		...
		service = getRestService(restTemplate, restProperties);
